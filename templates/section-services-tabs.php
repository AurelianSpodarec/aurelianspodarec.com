...
<div class="services-tab__container">
    ...
    <div class="services-tab__list-content">
        <div id="tab_complete-website" class="services-tab__tab-item is-visible">
            <h2 class="highlighted header-alternative"><span>Complete Website</span></h2>
        ...
        <div id="tab_psd-to-wordpress" class="services-tab__tab-item">
            <h2 class="highlighted header-alternative"><span>PSD to WordPress</span></h2>
        ...
        <div id="tab_psd-to-html" class="services-tab__tab-item">
            <h2 class="highlighted header-alternative"><span>PSD to HTML</span></h2>
