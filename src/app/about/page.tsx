...
function Box({ logo, logoName, title, description, icon }: any) {
  return (
    <div>
      <div className="relative dark:bg-[#171717] bg-[#f3f3f3] rounded border ">
        <div className="flex justify-center p-4">
          {logo && <img src={logo} className="h-12 rounded" />}
          {icon && <span className="text-2xl h-12">{icon}</span>}
        </div>
    ...
    <Container className="mt-16 sm:mt-32">
      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <p>Hiring the wrong front-end developer is an expensive mistake.</p>
          <p>Everyone is skilled to a degree, they can do what you want, but you'll probably found out that alone isn't enough.</p>

          <p>Clients would often complain that they are ghohested and getting stressed out because a freelancer disappeared but that's not somethng you'll have to worry with me; I will tell you directly if there is an issue and talk about it with you.</p>
          ...
          - Efficiency
          Refined little bits in my processes
      ...
      <div className="lg:order-first lg:row-span-2">
        <div className="mt-6 space-y-7 text-base text-zinc-700 dark:text-zinc-400">
          ...
          <section>
            ...
            <div>
              <h2 className="text-3xl font-bold">Beliefs and values</h2>
              <p>A short description of my vaues</p>
            </div>
            ...
            <div className="grid gap-3 grid-cols-6">
              <Box
                ...
                description="Crush goals"
              />
              <Box
                icon="🗿"
                title="Stoicism"
                description="Sh*t comes. Be calm"
              />
              <Box
                icon="📊"
                title="Growth led"
                description="Strive to be better"
              />
              <Box
                icon="🎨"
                title="Creativy"
        ...
        <div className="mt-6 space-y-7 text-base text-zinc-700 dark:text-zinc-400">
          ...
          <section>
            ...
            <div>
              ...
              <p>Tech that I specialise in and use on the front-end to create stunning websites and webapps</p>
            </div>
            ...
            <p className="italic text-sm mt-2">And yes, I've used more in the past... such as WordPress(Roots Sage), Laravel, Bootstrap, MaterialUI, Formik, etc... but I've decided to focus on the tech above - will consider other tech only if its a good fit with a fun project</p>
          </section>
        </div>
      </div>
